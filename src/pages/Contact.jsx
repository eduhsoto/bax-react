    ...
    <>
      ...
      <section className="mt-28 mb-52">
        <div className="mx-16 flex content-center items-center flex-col justify-center gap-16 tablet:mx-8 phone:mx-4">
          <h1 className="mb-14 text-[3.125rem] font-extrabold leading-[3.75rem] text-color_primary_2 tablet:text-center phone:text-[2.5rem]">Otros canales de comunicación</h1>
          <div className="w-full grid gap-16 grid-cols-3-auto justify-items-center items-stretch">
            <div className="flex items-center flex-col">
              ...
              <p className="text-color_primary_2 text-lg leading-[34px] tablet:text-center tablet:break-all">(+52) 22-2365- 8547</p>
            </div>
            <div className="flex items-center flex-col">
              <img src="./src/assets/img/channel-email.png" alt="channel email" />
              <p className="text-color_primary_2 text-lg leading-[34px]">E-mail:</p>
